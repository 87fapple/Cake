const nextEl = document.getElementById("carouselNext");
const previousEl = document.getElementById("carouselPrevious");
...
function setDotToInactive() {
    ...
    dots.children[index].classList.remove('dotActive')
}
function setActiveDot() {
    const { index } = slideProps
    dots.children[index].classList.add('dotActive')
}
